...
export const projects = [
  ...
  {
    path: "projects/CineVault.png", title: "CineVault Project", description: "Designed and developed a website which is a private film and series tracking system integrating a relational SQLite database, secure multiuser access, viewing analytics, data health checks, and encrypted backups, deployed on AWS EC2 with a responsive React interface.", languages: "JavaScript, HTML, CSS", frameworks: "NodeJs, ReactJs", tools: "Git", link: "https://github.com/Sujit-Halder/CineVault",
  },
];
